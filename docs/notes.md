...
В кодогене есть:
 ...
 - Объявление и использлование класса 
   - но без методов (кроме конструктов)
 - объявление указателей 

0. Вернуть встроенные типы 
 - проверить 2.Plus 
1. Обработка цепи вызовов
 - не парсится в 90% случаев
2. Дженерики 
  - нет ... :(
  - не обязательно
3. Массивов/Списки
 - парсятся 
 - нет кодогена
 - как для них операции то добавить
4. Stmts (Настя)
 - нет в кодогене
5. Есть модули! => можно будет пример с нескольими модулями
6. Libc 
7. Алгоритм дейкстры как пример главный
8. Main ? 
  - по референсу ты передаёшь название класа => его конструктор без параметров и является мейн 
  - класс Мейн

9. Каждую цифру превращаем в инстант объекта типа Интежер32
однако надо дать уникальное имя!

Приоритет:
- Сема проверить If/While/For/Switch (Настя)
  - подготовить пример дейкстры + 2.Plus() 
- Верну встроенные типы (Артём)
- Stmt (Настя)
- Массив (Артём)
- Цепи вызовов + `2.Plus()`
- Дженерики 
