...
//       : globalScope(globalScope), typeTable(typeTable), context(context),
//       sm(sm), buff(buff) {
...
//     auto ext_std_lib_info_impl =
//     std::make_unique<llvm::TargetLibraryInfoImpl>(
//       llvm::Triple(triple));
//     auto ext_std_lib_info =
//     std::make_unique<llvm::TargetLibraryInfo>(*ext_std_lib_info_impl);
...
//       true);
//     llvm::getOrInsertLibFunc(module.get(), *ext_std_lib_info,
//     llvm::LibFunc_printf, printfType);
...
//     false);
//     llvm::getOrInsertLibFunc(module.get(), *ext_std_lib_info,
//     llvm::LibFunc_malloc, mallocType);
...
//     // auto libc_module = std::make_unique<llvm::Module>("libc_module",
//     *context);
//     /*
...
//     bool linkStatus = llvm::Linker::linkModules(*module,
//     std::move(libc_module));
...
//     //
//     llvm::ArrayRef<llvm::Type*>({llvm::PointerType::get(llvm::Type::getInt8Ty(*context),
//     0)});
//     // llvm::FunctionType *printfType =
//     llvm::FunctionType::get(llvm::Type::getInt32Ty(*context),
//     printfArgsTypes, true);
...
//   void visit(ParameterDecl &node) override; // outsorced its work to another
//   function void visit(MethodDecl &node) override; void visit(ConstrDecl
//   &node) override; void visit(FuncDecl &node) override; void visit(ClassDecl
//   &node) override; void visit(ArrayDecl &node) override; // probably should
//   be deleted void visit(ListDecl &node) override; // same
//   // #####========================================#####
